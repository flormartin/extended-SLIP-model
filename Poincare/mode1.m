...
% import parameters
global g M m_L L0 m_B l0 l1 c_phi c_theta d1 d2 c1;
...
ddphi = (-c_phi*(x(3))     -d1*x(6) -c_theta*theta   -d2*dtheta    -m_L*g*sin(x(3))*l1+c1*(l0-l)*sin(x(3)-theta)*l1)    /(m_L*l1^2);
