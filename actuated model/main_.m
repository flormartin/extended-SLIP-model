...
% liftoff
x_lo_knee = X(1,N_phase+1) + l1 * sin(X(3,N_phase+1)) - offset; 
...
% opti.subject_to((X(1,N_phase+1)-offset)^2+X(2,N_phase+1)^2 == L0^2);
...
%actuation parameter constraints
opti.subject_to(-pi/2 < phi0 < 0);
opti.subject_to(-pi/2 < alpha0 < pi/2);
opti.subject_to(0 < omega < 100*pi/180);
